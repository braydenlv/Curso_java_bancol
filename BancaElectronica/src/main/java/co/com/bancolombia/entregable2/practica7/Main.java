...
public class Main {
    public static void main(String[] args) {
        ...
        Domicilio clienteTresDomicilio = new Domicilio("La Central", 23, "Medellin", "Antioquia", 587);
        //Cliente clienteUno = new Cliente(10, "Brayden Lopera", clienteUnoDomicilio, "rfcClienteUno", "6047895623", "02-05-1996");
        Cliente clienteTres = new Cliente.Builder(10, "Brayden Lopera")
                .domicilio(clienteTresDomicilio)
                .rfc("rfcClienteUno")
                .telefono("6047895623")
                .fechaNacimiento("02-05-1996")
                .build();
        CuentaDeAhorro cuentaAhorroClienteTres = new CuentaDeAhorro(1001, 1000001, 1.01);
        CuentaDeCheque cuentaChequeClienteTres = new CuentaDeCheque(1002, 2000001, 12000);
